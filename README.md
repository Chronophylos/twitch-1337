...
A Rust-based Twitch IRC bot for the channel [euterheissgetraenk](https://twitch.tv/euterheissgetraenk). Maintains a persistent IRC connection with broadcast-based message routing to multiple independent handlers.
...
The shaded area shows where aircraft are considered "overhead." Aircraft above the line are too far away for their altitude.
...
Created for the Twitch channel [euterheissgetraenk](https://twitch.tv/euterheissgetraenk).
