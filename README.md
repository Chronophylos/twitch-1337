...
export TWITCH_CHANNEL=euterheissgetraenk  # optional
...
docker run -d \
  ...
  -e TWITCH_CHANNEL=euterheissgetraenk \
  -e RUST_LOG=info \
...
services:
  twitch-1337:
    ...
    environment:
      ...
      TWITCH_CHANNEL: euterheissgetraenk
      RUST_LOG: info
```
...
Environment="TWITCH_CHANNEL=euterheissgetraenk"
